...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getGifs() async {
    ...
    if (_isNullOrEmpty(_search)) {
      ...
      response = await http
          .get('https://api.giphy.com/v1/gifs/trending?api_key=Q1EZqVdHkGu2De4tEhsLYkNiRH0axpiu&limit=20&rating=g');
    } else {
      print('_search: $_search');
      response = await http.get(
          'https://api.giphy.com/v1/gifs/search?api_key=Q1EZqVdHkGu2De4tEhsLYkNiRH0axpiu&q=$_search&limit=$_limit&offset=$_offset&rating=g&lang=en');
    }
